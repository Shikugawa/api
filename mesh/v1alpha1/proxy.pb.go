...
type Tracing_Skywalking struct {
	Skywalking *Tracing_SkyWalking `protobuf:"bytes,10,opt,name=skywalking,proto3,oneof" json:"skywalking,omitempty"`
}
...
func (*Tracing_Skywalking) isTracing_Tracer()       {}
...
func (m *Tracing) GetSkywalking() *Tracing_SkyWalking {
	if x, ok := m.GetTracer().(*Tracing_Skywalking); ok {
		return x.Skywalking
	}
	return nil
}
...
// Configurations for Apache SkyWalking tracer.
type Tracing_SkyWalking struct {
	// Address of the SkyWalking OAP.
	Address string `protobuf:"bytes,1,opt,name=address,proto3" json:"address,omitempty"`
	// Access token of SkyWalking OAP.
	AccessToken          string   `protobuf:"bytes,2,opt,name=access_token,json=accessToken,proto3" json:"accessToken,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
...
func (m *Tracing_SkyWalking) GetAccessToken() string {
	if m != nil {
		return m.AccessToken
	}
	return ""
...
var fileDescriptor_5efecd978cf3d28d = []byte{
	...
	,
}
